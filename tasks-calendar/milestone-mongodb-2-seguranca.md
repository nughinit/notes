...
- [ ] [11. Migrar os 17 tribunais restantes em sitemap genérico](mongodb-seguranca/11-batch2-sitemap-migration.md) ⚠️ **11/17 corrigidos (TJAC, TJDFT, TJMA, TJCE, TRT24, TJPR, TJMMG, TRT1, TJES, TJRJ, TJRS); 2 bloqueados por CAPTCHA/verificação humana (TRT17, TJSC); 6 restantes**
