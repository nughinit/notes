...
> Revisado em 2026-08-18: item 3 (gate de aprovação) tinha contagem de
> retrofit desatualizada — corrigida abaixo após checar o código atual em
> `scripts/`.
...
concluído — status real revisado no próprio arquivo). Este aqui ataca as
vulnerabilidades identificadas no processo de coleta e triagem de portarias,
priorizadas pelo impacto real num produto jurídico: **dado errado sem alarme
...
- [ ] [3. Gate de aprovação antes de promoção a L8 / resolução de gap](mongodb-seguranca/03-gate-aprovacao-promocao-l8.md) ⚠️ **parcial — gate criado e testado, retrofit em 11/19 scripts** (corrigido; era 1/18) — **ALTO**
...
podem também estar desatualizados; verificar antes de tratar como
definitivos.)*
...
`STATUS PASS`, 92/92 tribunais em L8) — **nota: o status "PASS" citado aqui
também foi corrigido, ver [milestone-mongodb-perfeito.md](milestone-mongodb-perfeito.md)**.
